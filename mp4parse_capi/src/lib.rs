...
/// should be valid.
#[no_mangle]
pub unsafe extern "C" fn mp4parse_new(io: *const Mp4parseIo) -> *mut Mp4parseParser {
...
#[no_mangle]
pub unsafe extern "C" fn mp4parse_read(parser: *mut Mp4parseParser) -> Mp4parseStatus {
...
#[cfg(test)]
extern "C" fn panic_read(_: *mut u8, _: usize, _: *mut std::os::raw::c_void) -> isize {
