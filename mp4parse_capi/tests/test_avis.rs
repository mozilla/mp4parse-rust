...
fn default_avif_info() -> Mp4parseAvifInfo {
    Mp4parseAvifInfo {
        ...
        primary_item_a1lx: std::ptr::null(),
        alpha_item_a1lx: std::ptr::null(),
        primary_item_lsel_layer_id: 0xffff,
        primary_item_extents: Default::default(),
        alpha_item_extents: Default::default(),
        primary_item_is_file_construction: Default::default(),
        alpha_item_is_file_construction: Default::default(),
